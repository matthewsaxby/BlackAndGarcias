...
<div class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="nav-collapse collapse">
            ...
            <c:if test="${sessionBean.userType>0}">
			  	...
			  	<li><form class="navbar-form pull-right" action='controller' method='POST'>
	            		...
	            		<input type="hidden" name="source" value="confirmSignup.jsp" />
    ...
    <div class="container">
      ...
      <div class="hero-unit">
        <h1>Your Signed up</h1>
        <p>Please check your email and follow the link to complete the application process</p>
