...
insert into cinema (name, address, seating_capacity, facilities) values ('The Ritz', 'Randwick, NSW', 350, 'popcorn, 3D');

insert into movie (title, poster, synopsis, user_rating, rating_count, release_date, director, age_rating, genres) 
values ('Transformers', 'images/trans.jpg', 
...
7.2, 5, '2007-06-28', 'Michael Bay', 'PG-13', 'Action, Scifi, Thriller');
...
INSERT INTO movie (title, poster, synopsis, user_rating, rating_count, release_date, director, age_rating, genres) 						   VALUES ('The Lion King', 'images/lionking.jpg', 'Tricked into thinking he killed his father, a guilt ridden lion cub flees into exile and abandons his identity as the future King.', -1, 0, '1994-08-25', 'Zazu', 'G', 'Animation, Children, Drama')



insert into actor (first_name, last_name) values ('Peter', 'Smith');
insert into actor (first_name, last_name) values ('John', 'Rogers');
insert into actor (first_name, last_name) values ('Simba', 'Lion');


insert into user_tbl (username, usertype, password, emailaddress) values ('admin', 2, 'admin', 'lachlan.dally@gmail.com');
insert into user_tbl (username, usertype, password, emailaddress) values ('user', 1, 'user', 'lachlan.dally@gmail.com');
...
insert into movie_actors (actor_id, movie_id) values (3, 5);


INSERT INTO showing (showingTime, showingDate, availableSeats, cinema_id, movie_id)
VALUES('18:00:00', '2012-06-04', 50, 1, 3);

INSERT INTO showing (showingTime, showingDate, availableSeats, cinema_id, movie_id)
VALUES('16:00:00', '2012-12-04', 50, 1, 3);

INSERT INTO showing (showingTime, showingDate, availableSeats, cinema_id, movie_id)
VALUES('18:00:00', '0026-06-04', 430, 2, 3);
